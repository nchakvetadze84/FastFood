...
namespace FastFood
{
    public partial class CYMessageBox : Form
    {
        ...
        static private void BuildMessageBox(string title)
        {
            ...
            newMessageBox.FormClosed += new System.Windows.Forms.FormClosedEventHandler(CYMessageBox_FormClosed);
            ...
            frmMessage.Font = new Font("Sylfaen", 9, FontStyle.Regular);
        ...
        private static void CYMessageBox_FormClosed(object sender, FormClosedEventArgs e)
        {
            //newMessageBox.Dispose();
        }
